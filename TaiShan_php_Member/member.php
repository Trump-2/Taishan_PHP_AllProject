...
<body>
  <header class=nav>
    ...
    <div class="nav-item col-4">
      ...
      ?>
      <a href="register.php" class='btn btn-primary mx-2'>註冊</a>
  ...
  <div class="container">
    <h1>使用者資料</h1>
    <form action="update.php" method="post" class="m-auto col-4">
      ...
      <div class="d-flex justify-content-center">
        <input class="btn-primary" type="submit" value="更新">
        <input class="btn btn-warning" type="reset" value="重置">
        <input class="btn btn-danger" type="button" value="消失">
      </div>
    </form>
  </div>
</body>
